...
import { A as AuthLocalization, a as AccountViewPath, b as AuthViewPath, c as AuthViewPaths, O as OrganizationViewPath } from './view-paths-DaSAvCTe.cjs';
export { f as AccountViewPaths, g as OrganizationViewPaths, e as accountViewPaths, h as authLocalization, d as authViewPaths, o as organizationViewPaths } from './view-paths-DaSAvCTe.cjs';
import * as React from 'react';
import { ComponentProps, ReactNode } from 'react';
import * as AvatarPrimitive from '@radix-ui/react-avatar';
import { P as PasswordValidation, F as FieldType } from './auth-ui-provider-Cx9buCn9.cjs';
export { A as AppleIcon, n as AuthUIContext, l as AuthUIContextType, o as AuthUIProvider, m as AuthUIProviderProps, D as DiscordIcon, c as DropboxIcon, d as FacebookIcon, G as GitHubIcon, e as GitLabIcon, f as GoogleIcon, H as HuggingFaceIcon, K as KickIcon, L as LinearIcon, g as LinkedInIcon, M as MicrosoftIcon, N as NotionIcon, p as Provider, b as ProviderIcon, a as ProviderIconProps, R as RedditIcon, h as RobloxIcon, S as SlackIcon, i as SpotifyIcon, q as TeamOptions, r as TeamOptionsContext, T as TikTokIcon, j as TwitchIcon, k as VKIcon, V as VercelIcon, X as XIcon, Z as ZoomIcon, s as socialProviders } from './auth-ui-provider-Cx9buCn9.cjs';
import * as DialogPrimitive from '@radix-ui/react-dialog';
import { R as Refetch, T as Team, A as AnyAuthClient } from './auth-hooks-CVB_Gvg9.cjs';
export { a as AuthHooks, b as TeamMember } from './auth-hooks-CVB_Gvg9.cjs';
...
declare function SignInForm({ className, classNames, isSubmitting, localization, redirectTo, setIsSubmitting, passwordValidation, callbackURL }: SignInFormProps): react_jsx_runtime.JSX.Element;
 ...
 */
declare function OrganizationSwitcher({ className, classNames, align, alignOffset, side, sideOffset, trigger, localization: localizationProp, slug: slugProp, size, onSetActive, hidePersonal, hideCreate, ...props }: OrganizationSwitcherProps): react_jsx_runtime.JSX.Element;
...
declare function UpdateFieldCard({ className, classNames, description, instructions, localization: localizationProp, name, placeholder, required, label, type, multiline, value, validate, errorMessage, options, onUpdateComplete }: UpdateFieldCardProps): react_jsx_runtime.JSX.Element;
