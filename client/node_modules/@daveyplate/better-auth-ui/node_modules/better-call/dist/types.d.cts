 ...
 */
type ResolveInferValue<T> = T extends StandardSchemaV1 ? StandardSchemaV1.InferOutput<T> : T;
type ResolveInferValueInput<T> = T extends StandardSchemaV1 ? StandardSchemaV1.InferInput<T> : T;
/**
...
} ? ResolveInferValue<B> : S extends StandardSchemaV1 ? StandardSchemaV1.InferOutput<S> : any;
/**
...
} ? ResolveInferValue<Q> : S extends StandardSchemaV1 ? StandardSchemaV1.InferOutput<S> : Record<string, any> | undefined;
/**
...
} ? ResolveInferValueInput<B> : S extends StandardSchemaV1 ? StandardSchemaV1.InferInput<S> : undefined;
/**
...
} ? ResolveInferValueInput<Q> : S extends StandardSchemaV1 ? StandardSchemaV1.InferInput<S> : Record<string, any> | undefined;
/**
